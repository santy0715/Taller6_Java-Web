            ...
            <form action="" method="post">
                <img class="mb-4" src="./css/img/registro1.png"></img>
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingName" placeholder="ingrese su Nombre" required autofocus pattern="[A-Za-z ]{3,50}">
                        </input>
                    <label for="floatingName">Nombre:</label>
                    </div>
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingApellido" placeholder="ingrese su Apellido" required pattern="[[A-Za-z ]{3,50}">
                    </input>
                ...
                <div class="form-floating">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="ingrese su Contraseña" required pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$">
                    </input>
